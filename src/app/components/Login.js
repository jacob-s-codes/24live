  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-darkblue to-yellow flex flex-col items-center justify-center">
      <div className='flex flex-col items-center justify-center text-black gap-y-4 bg-white backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200/50 p-8 w-full max-w-md'>
        ...
        {/* Sign in card */}
        <div className="bg-white backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200/50 p-8 w-full max-w-md">
          {error && (
          ...
          <div className="space-y-6">
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-700 font-medium py-3 px-4 rounded-lg border border-gray-300 shadow-sm transition-all duration-200 hover:shadow-md hover:scale-[1.02] active:scale-[0.98] group disabled:opacity-50 disabled:cursor-not-allowed"
            >
